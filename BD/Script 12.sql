...
(pNombreSede IN varchar2, pCodPostal IN varchar2,pProvincia IN varchar2,pCanton IN varchar2,pDistrito IN varchar2,pDireccionExacta IN varchar2)
AS 
BEGIN
    INSERT INTO TBSEDES(ATNombreSede,ATCodPostal,ATProvincia,ATCanton,ATDistrito,ATDireccionExacta)
    VALUES (pNombreSede,pCodPostal,pProvincia,pCanton,pDistrito,pDireccionExacta);
END;

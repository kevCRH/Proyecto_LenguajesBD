    ...
    public partial class AgregarUsuario : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                comandoAgregar.Parameters.Add("activo", OracleType.Char).Value = ddmEstado.SelectedValue.ToString();
                comandoAgregar.Parameters.Add("rol", OracleType.Number).Value = ddmRol.SelectedValue.ToString();
